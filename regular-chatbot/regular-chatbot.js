...
export function checkPhoneNumber(number) {
  ...
  return phoneRegex.test(number) ? 'Thanks! You can now download me to your phone.' : `Oops, it seems like I can't reach out to ${number}`;
}
...
export function getURL(userInput) {
  return userInput.match(/\w+\.\w{2,}/g);
}
